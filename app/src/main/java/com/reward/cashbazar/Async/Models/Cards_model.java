...
public class Cards_model implements Serializable {
    ...
    public String getWrongMoves() {
        return wrongMoves;
    }

    public void setWrongMoves(String wrongMoves) {
        this.wrongMoves = wrongMoves;
    }

    private String wrongMoves;
...
//    }
    ...
    public List<Cards_Menu> getData() {
        return data;
    }

    public void setData(List<Cards_Menu> data) {
        this.data = data;
    }
