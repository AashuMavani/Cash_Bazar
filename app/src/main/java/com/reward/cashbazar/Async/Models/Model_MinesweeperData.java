...
public class Model_MinesweeperData implements Serializable {
    ...
    @Expose
    private List<Item_MinestdataData> data;
    ...
    public List<Item_MinestdataData> getData() {
        return data;
    }

    public void setData(List<Item_MinestdataData> data) {
        this.data = data;
    }
