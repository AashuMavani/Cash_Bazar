...
public class Refer_Point_Detail_Fragment extends Fragment {
    private View view;
    ...
    public Refer_Point_Detail_Fragment() {
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        rvHistoryList.setAdapter(new Point_Detail_Adapter(listPointHistory, getActivity(), POC_Constants.HistoryType.REFER_POINT));
        ...
        nestedScrollView.setOnScrollChangeListener(new NestedScrollView.OnScrollChangeListener() {
            ...
            public void onScrollChange(NestedScrollView v, int scrollX, int scrollY, int oldScrollX, int oldScrollY) {
                if (scrollY == v.getChildAt(0).getMeasuredHeight() - v.getMeasuredHeight()) {
                    if (pageNo < numOfPage) {
                        new Get_Point_Detail_Async(getActivity(), POC_Constants.HistoryType.REFER_POINT, String.valueOf(pageNo + 1));
                    }
                }
            }
        });
        new Get_Point_Detail_Async(getActivity(), POC_Constants.HistoryType.REFER_POINT, String.valueOf(pageNo));
    }
