...
import com.reward.cashbazar.Adapter.Quiz_AllDetail_Adapter;
...
public class All_Quiz_Detail_Fragment extends Fragment {
    private View view;
    ...
    private final List<Quiz_All_Detail_Item> listPointHistory = new ArrayList<>();
    ...
    public All_Quiz_Detail_Fragment() {
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        rvHistoryList.setAdapter(new Quiz_AllDetail_Adapter(listPointHistory, getActivity()));
        ...
        nestedScrollView.setOnScrollChangeListener(new NestedScrollView.OnScrollChangeListener() {
            ...
            public void onScrollChange(NestedScrollView v, int scrollX, int scrollY, int oldScrollX, int oldScrollY) {
                if (scrollY == v.getChildAt(0).getMeasuredHeight() - v.getMeasuredHeight()) {
                    if (pageNo < numOfPage) {
                        new Get_Quiz_Point_Detail_Async(getActivity(), POC_Constants.HistoryType.QUIZ_ALL_CONTEST, String.valueOf(pageNo + 1));
                    }
                }
            }
        });
        new Get_Quiz_Point_Detail_Async(getActivity(), POC_Constants.HistoryType.QUIZ_ALL_CONTEST, String.valueOf(pageNo));
    }
