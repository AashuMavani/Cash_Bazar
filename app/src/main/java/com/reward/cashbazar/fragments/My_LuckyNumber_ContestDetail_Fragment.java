...
import com.reward.cashbazar.Adapter.Lucky_Number_Consent_MyHistory_Adapter;
import com.reward.cashbazar.Async.Get_Lucky_Number_Point_Detail_Async;
import com.reward.cashbazar.Async.Models.Lucky_Number_MyDetail_Item;
...
public class My_LuckyNumber_ContestDetail_Fragment extends Fragment {
    private View view;
    ...
    private final List<Lucky_Number_MyDetail_Item> listPointHistory = new ArrayList<>();
    ...
    public My_LuckyNumber_ContestDetail_Fragment() {
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        rvHistoryList.setAdapter(new Lucky_Number_Consent_MyHistory_Adapter(listPointHistory, getActivity()));
        ...
        nestedScrollView.setOnScrollChangeListener(new NestedScrollView.OnScrollChangeListener() {
            ...
            public void onScrollChange(NestedScrollView v, int scrollX, int scrollY, int oldScrollX, int oldScrollY) {
                if (scrollY == v.getChildAt(0).getMeasuredHeight() - v.getMeasuredHeight()) {
                    if (pageNo < numOfPage) {
                        new Get_Lucky_Number_Point_Detail_Async(getActivity(), POC_Constants.HistoryType.LUCKY_NUMBER_MY_CONTEST, String.valueOf(pageNo + 1));
                    }
                }
            }
        });
        new Get_Lucky_Number_Point_Detail_Async(getActivity(), POC_Constants.HistoryType.LUCKY_NUMBER_MY_CONTEST, String.valueOf(pageNo));
    }
