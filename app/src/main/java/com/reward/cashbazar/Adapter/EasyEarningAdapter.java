...
public abstract class EasyEarningAdapter extends RecyclerView.Adapter<EasyEarningAdapter.ViewHolder> {

    private Activity activity;
    private List<Home_Data_Model> data;
    private ClickListener clickListener;

    public EasyEarningAdapter(final Activity context, List<Home_Data_Model> data, ClickListener clickListener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_earn_grid_porogress, parent, false);
