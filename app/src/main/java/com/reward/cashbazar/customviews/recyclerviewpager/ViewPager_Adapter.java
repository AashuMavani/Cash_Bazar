...
public class ViewPager_Adapter extends RecyclerView.Adapter<ViewPager_Adapter.ViewHolder> {
    ...
    public ViewPager_Adapter(Context context, List<Home_Slider_Menu> categorie) {
        this.list = categorie;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View viewItem = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_home_loader, parent, false);
