...
public class ViewPager_Adapter_Login extends RecyclerView.Adapter<ViewPager_Adapter_Login.ViewHolder> {
    ...
    public ViewPager_Adapter_Login(Context context, List<Home_Slider_Menu> categorie) {
        this.list = categorie;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View viewItem = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_login_slider_pogress, parent, false);
