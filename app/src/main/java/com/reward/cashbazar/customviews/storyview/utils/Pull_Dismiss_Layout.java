...
public class Pull_Dismiss_Layout extends FrameLayout {
    private Listener listener;
    private ViewDragHelper dragHelper;
    private float minFlingVelocity;
    private float verticalTouchSlop;
    private Touch_Callbacks mTouchCallbacks;
    private boolean animateAlpha;

    public Pull_Dismiss_Layout(@NonNull Context context) {
        super(context);
        init(context);
    }

    public Pull_Dismiss_Layout(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public Pull_Dismiss_Layout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context);
    }

    @TargetApi(21)
    public Pull_Dismiss_Layout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyle, int defResStyle) {
    ...
    private static class ViewDragCallback extends ViewDragHelper.Callback {
        private Pull_Dismiss_Layout pullDismissLayout;
        private int startTop;
        private float dragPercent;
        private View capturedView;
        private boolean dismissed;

        private ViewDragCallback(Pull_Dismiss_Layout layout) {
    ...
    public void setmTouchCallbacks(Touch_Callbacks mTouchCallbacks) {
    ...
    public Touch_Callbacks getmTouchCallbacks() {
