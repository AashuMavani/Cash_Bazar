...
public class Recycler_ViewPager extends RecyclerView {
    ...
    public Recycler_ViewPager(@NonNull Context context) {
        super(context);
        initState();
    }


    public Recycler_ViewPager(@NonNull Context context, @Nullable AttributeSet attrs) {
    ...
    public Recycler_ViewPager(@NonNull Context context, @Nullable AttributeSet attrs, int defStyle) {
   ...
   /* private void scrollToNext() {
    ...
    public void start() {
        try {
            adapter = new ViewPager_Adapter(getContext(), pagerModels);
            setAdapter(adapter);
            if (runAuto) {
                if (timer == null)
                    timer = new Timer();
    ...
    public void setOnItemClickListener(ViewPager_Adapter.OnItemClickListener itemClickListener) {
        try {

            ((ViewPager_Adapter) getAdapter()).setOnclickItemListener(itemClickListener);
